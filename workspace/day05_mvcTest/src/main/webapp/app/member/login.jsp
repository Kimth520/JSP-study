...
<!--css, js, img 등의 파일을 우리 이클립스 기준으로 잡는게 아니라 
우리가 만든 파일들도 웹상에 같이 올라가기 때문에 url 경로로 잡아야 함 
루트 경롤르 우리가 설정한 /day05_mvcTest로 직접 명시하면 나중에 루트가 바뀌었을 때 전부 수정해야함
jstl에서 제공하는 ${PageContext.request.contextPath}를 사용하여 루트 경로 설정
-->
